...
Para su desarrollo, se empleará el lenguaje de programación javascript en el entorno de desarrollo de phaser. En cuanto a la edición de sonido e imágenes, se utilizarán los programas Reaper y Photoshop respectivamente.

# Mecánicas de juego
Crear plataformas:\
El campo de juego está dividido con una cuadrícula. Desde la parte superior de la pantalla, caen dos plataformas (una por jugador) inspiradas por el juego clásico "Tetris". Su comportamiento general en cuanto a forma y reglas de movimiento es parecido a este juego.
...
Los jugadores colisionarán con las plataformas en todas direcciones (no podrán atravesarlas desde abajo), y posiblemente con otras entidades que sean añadidas al juego. No colisionarán entre ellos y no tendrán una manera directa de influenciar al otro personaje.
